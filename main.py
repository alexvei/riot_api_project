...
class Scraper():
    ...
    def api_urls(self, url: str, header: str):
        url = url + header + 'api_key=' + self.api_key
    ...
    def list_sorter(self, list_to_sort: list):
...
parser.add_argument("-k", "--key", type=str, help="Use API key.")
